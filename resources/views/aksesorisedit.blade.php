    ...
    <div class="card-body">
        ...
        <form action="/aksesoris/update/{{$aksesoris->id_aksesoris}}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_aksesoris" value="{{$aksesoris->nama_aksesoris}}">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Harga</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="harga" value="{{$aksesoris->harga}}">
                </div>
            </div>
